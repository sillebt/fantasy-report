...
We can’t do this with hostages. We're not working on a small menu. And I'm not a big fan of the term 'rebuilding.' I prefer "reloading". And, I don't do hypotheticals. I know that we have some plays that need to be made, and somebody on this roster has to make them. There’s going to be some joyful lifting for us, if you will. We’re still squirreling with those nuts. 


It's not about what we want to do, it's about what we do. We make no excuses, we seek no comfort. It's like McDonalds.You know what #1 is, no matter what corner of the globe a #1 is a #11. That's what I want this football team to be. **The standard is the standard.**" 
